...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt === false) {
        ...
        if ($stmt->execute()) {
            $_SESSION['message'] = 'sumakses ka'; // Success flag if needed
    ...
    <div id="successModal" class="modal-overlay" style="display: none;">
        <div class="modal-content">
            <div class="modal-title">
                <h3>Found Item Report Submitted!</h3>
            ...
            <p class="modal-cont">If you have any questions or need to provide more details about the item, please reach
                out to us
                at 89-9999 or visit our Lost & Found office</p>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="time_found" id="time_found" required aria-required="true"
                            class="form-control">
                    </div>
