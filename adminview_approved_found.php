...
if (isset($_GET['_id']) && filter_var($_GET['_id'], FILTER_VALIDATE_INT)) {
    ...
    $sql = "SELECT * FROM approved_found_reports WHERE id = ?";
    ...
    if (isset($_POST['approve'])) {
        ...
        $insertSql = "INSERT INTO approved_found_reports 
        ...
        if ($insertStmt->execute()) {
            ...
            $deleteSql = "DELETE FROM approved_found_reports WHERE id = ?";
            ...
            // Redirect to pending_found_report.php
            header("Location: approved_found_report.php");
            exit;
        } else {
...
<body>
    ...
    <div class="container-wrapper">
        ...
        <div class="container">
            ...
            <div class="btn-container">
                <a href="approved_found_report.php" class="btn btn-back">Back</a>
                <form method="POST">
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <p class="footer-text">&copy; Universtiy of Caloocan City, All rights reserved.</p>
        </div>
    </footer>
</body>
