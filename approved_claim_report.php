...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['approve_id'])) {
    ...
    $stmtSelect = $conn->prepare("SELECT * FROM approved_claim_reports WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $stmtSelect = $conn->prepare("SELECT picture FROM approved_claim_reports WHERE id = ?");
...
$sqlCount = "SELECT COUNT(*) AS total FROM approved_claim_reports WHERE status='unclaimed'";
if (!empty($search)) {
...
$sql = "SELECT * FROM approved_claim_reports WHERE status='unclaimed'";
